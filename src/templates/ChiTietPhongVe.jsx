    ...
    <>
      ...
      <div className="flex justify-center mb-10 mt-16">
        <div className="w-2/3 flex">
          <div className="w-2/3">
            <div>
              <div className="flex space-x-5 mt-10">
                <div align="center">
                  <div className="bg-slate-100 w-[40px] h-[40px] rounded-md flex items-center justify-center mb-2"></div>{' '}
                  Ghế thường
                </div>

                <div align="center">
                  <div className="bg-orange-400 w-[40px] h-[40px] rounded-md flex items-center justify-center mb-2"></div>{' '}
                  Ghế Vip
                </div>
                <div align="center">
                  <div className="bg-green-400 w-[40px] h-[40px] rounded-md flex items-center justify-center mb-2"></div>{' '}
                  Ghế Đang Chọn
                </div>
                <div align="center">
                  <div className="bg-red-400 w-[40px] h-[40px] rounded-md flex items-center justify-center mb-2"></div>{' '}
                  Ghế Đã Chọn
                </div>
              </div>
          ...
          <div className="w-1/3 bg-slate-100 rounded-lg p-5 mt-16">
